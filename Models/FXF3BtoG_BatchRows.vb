...
Namespace Models
    ...
    Public Class FXF3B_BatchRow
        ...
        Private _genGeoA As String = "NA" : Public Property GenGeoA As String
            ...
            End Set
        End Property
        Private _clsZipAuth As String = "" : Public Property ClsZipAuth As String
            Get
                Return _clsZipAuth
            End Get
            Set(v As String)
                SetField(_clsZipAuth, v)
            End Set
        End Property
        Private _clsZipNum As String = "" : Public Property ClsZipNum As String
            Get
                Return _clsZipNum
            End Get
            Set(v As String)
                SetField(_clsZipNum, v)
            End Set
        End Property
        Private _clsZipSec As String = "" : Public Property ClsZipSec As String
            Get
                Return _clsZipSec
            End Get
            Set(v As String)
                SetField(_clsZipSec, v)
            End Set
        End Property
        Private _excClass As String = "" : Public Property ExcClass As String
            Get
                Return _excClass
            End Get
            Set(v As String)
                SetField(_excClass, v)
            End Set
        End Property
        Private _excClassMaxWgt As String = "" : Public Property ExcClassMaxWgt As String
            Get
                Return _excClassMaxWgt
            End Get
            Set(v As String)
                SetField(_excClassMaxWgt, v)
            End Set
        End Property
        ...
        Public Function ToItemClass() As FXF3B.itemClass
            ...
            it.classZipAuthority  = ClsZipAuth
            it.classZipNumber     = ClsZipNum
            it.classZipSection    = ClsZipSec
            it.excClass           = ExcClass
            it.excClassMaxWgt     = ExcClassMaxWgt
        ...
        Public Sub FromItemClass(it As FXF3B.itemClass)
            ...
            ClsZipAuth   = it.classZipAuthority
            ClsZipNum    = it.classZipNumber
            ClsZipSec    = it.classZipSection
            ExcClass     = it.excClass
            ExcClassMaxWgt = it.excClassMaxWgt
