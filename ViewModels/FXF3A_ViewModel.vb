    ...
    Public Class FXF3A_ViewModel
        ...
        Private Sub ExecuteLoadCsv()
            ...
            For i As Integer = 1 To lines.Length - 1
                ...
                Try
                    ...
                    row.Disc1     = G("Disc1") : row.MinChg1    = G("MinChg1") : row.MaxWgt1    = G("MaxWgt1") : row.FloorMin1 = G("FloorMin1") : row.EffDate1  = G("EffDate1") : row.CanDate1  = G("CanDate1")
                    row.Disc2     = G("Disc2") : row.MinChg2    = G("MinChg2") : row.MaxWgt2    = G("MaxWgt2") : row.FloorMin2 = G("FloorMin2") : row.EffDate2  = G("EffDate2") : row.CanDate2  = G("CanDate2")
                    row.Disc3     = G("Disc3") : row.MinChg3    = G("MinChg3") : row.MaxWgt3    = G("MaxWgt3") : row.FloorMin3 = G("FloorMin3") : row.EffDate3  = G("EffDate3") : row.CanDate3  = G("CanDate3")
                    ...
                    row.ThirdParty = If(Core.CsvHelper.GetBool(f, hdr, "ThirdParty"), "Y", "N")
                    ...
                    row.GeoSt1    = G("GeoSt1")
                    row.GeoCty1   = G("GeoCty1")
                    row.GeoDir2   = GD("GeoDir2",  "NA")
                    row.GeoType2  = GD("GeoType2", "NA")
                    row.GeoName2  = G("GeoName2")
                    row.GeoSt2    = G("GeoSt2")
                    row.GeoCty2   = G("GeoCty2")
                    row.RatesEff  = G("RatesEff")
                    ...
                    row.CzNum     = G("CzNum")
                    row.CzSec     = G("CzSec")
                    row.ApplyArbs = If(Core.CsvHelper.GetBool(f, hdr, "ApplyArbs"), "Y", "N")
                    row.ExcCls    = G("ExcCls")
                    row.ExcMaxW   = G("ExcMaxW")
                    row.GenGeoA   = GD("GenGeoA",  "NA")
                    row.MinWgt    = G("MinWgt")
                    row.MaxWgt    = G("MaxWgt")
                    row.IncExempt = If(Core.CsvHelper.GetBool(f, hdr, "IncExempt"), "Y", "N")
                    row.Fak       = If(Core.CsvHelper.GetBool(f, hdr, "Fak"),       "Y", "N")
                    row.EdAgg     = G("EdAgg")
                    row.N50   = If(Core.CsvHelper.GetBool(f, hdr, "N50"),   "Y", "N")
                    row.N55   = If(Core.CsvHelper.GetBool(f, hdr, "N55"),   "Y", "N")
                    row.N60   = If(Core.CsvHelper.GetBool(f, hdr, "N60"),   "Y", "N")
                    row.N65   = If(Core.CsvHelper.GetBool(f, hdr, "N65"),   "Y", "N")
                    row.N70   = If(Core.CsvHelper.GetBool(f, hdr, "N70"),   "Y", "N")
                    row.N77_5 = If(Core.CsvHelper.GetBool(f, hdr, "N77_5"), "Y", "N")
                    row.N85   = If(Core.CsvHelper.GetBool(f, hdr, "N85"),   "Y", "N")
                    row.N92_5 = If(Core.CsvHelper.GetBool(f, hdr, "N92_5"), "Y", "N")
                    row.N100  = If(Core.CsvHelper.GetBool(f, hdr, "N100"),  "Y", "N")
                    row.N110  = If(Core.CsvHelper.GetBool(f, hdr, "N110"),  "Y", "N")
                    row.N125  = If(Core.CsvHelper.GetBool(f, hdr, "N125"),  "Y", "N")
                    row.N150  = If(Core.CsvHelper.GetBool(f, hdr, "N150"),  "Y", "N")
                    row.N175  = If(Core.CsvHelper.GetBool(f, hdr, "N175"),  "Y", "N")
                    row.N200  = If(Core.CsvHelper.GetBool(f, hdr, "N200"),  "Y", "N")
                    row.N250  = If(Core.CsvHelper.GetBool(f, hdr, "N250"),  "Y", "N")
                    row.N300  = If(Core.CsvHelper.GetBool(f, hdr, "N300"),  "Y", "N")
                    row.N400  = If(Core.CsvHelper.GetBool(f, hdr, "N400"),  "Y", "N")
                    row.N500  = If(Core.CsvHelper.GetBool(f, hdr, "N500"),  "Y", "N")
                    row.PayRule1  = G("PayRule1")
                    row.PayRule2  = G("PayRule2")
        ...
        Public Sub LoadRows(rows As List(Of Dictionary(Of String, String)))
            ...
            For Each rowDict As Dictionary(Of String, String) In rows
                ...
                br.Disc1     = G("DISC1") : br.MinChg1 = G("MINCHG1") : br.MaxWgt1 = G("MAXWGT1") : br.FloorMin1 = G("FLOORMIN1") : br.EffDate1  = G("EFFDATE1") : br.CanDate1  = G("CANDATE1")
                br.Disc2     = G("DISC2") : br.MinChg2 = G("MINCHG2") : br.MaxWgt2 = G("MAXWGT2") : br.FloorMin2 = G("FLOORMIN2") : br.EffDate2  = G("EFFDATE2") : br.CanDate2  = G("CANDATE2")
                br.Disc3     = G("DISC3") : br.MinChg3 = G("MINCHG3") : br.MaxWgt3 = G("MAXWGT3") : br.FloorMin3 = G("FLOORMIN3") : br.EffDate3  = G("EFFDATE3") : br.CanDate3  = G("CANDATE3")
                ...
                br.GeoSt1    = G("GEOST1")
                br.GeoCty1   = G("GEOCTY1")
                br.GeoDir2   = GD("GEODIR2",  "NA")
                br.GeoType2  = GD("GEOTYPE2", "NA")
                br.GeoName2  = G("GEONAME2")
                br.GeoSt2    = G("GEOST2")
                br.GeoCty2   = G("GEOCTY2")
                br.RatesEff  = G("RATESEFF")
                ...
                br.MaxWgt    = G("MAXWGT")
                br.EdAgg     = G("EDAGG")
                br.PayRule1  = G("PAYRULE1")
                br.PayRule2  = G("PAYRULE2")
                br.FsAuth    = G("FSAUTH")
                br.FsNum     = G("FSNUM")
                br.FsItem    = G("FSITEM")
                br.Country   = G("COUNTRY")
                ...
                br.ApplyArbs  = If(G("APPLYARBS").ToUpper()  = "Y", "Y", "N")
                br.IncExempt  = If(G("INCEXEMPT").ToUpper()  = "Y", "Y", "N")
